...
def main() -> None:
    ...
    print(f"Directas  : {result.get('direct_count', 'N/D')}")
    print(f"Cand. res.: {result.get('summary_candidate_count', 'N/D')}")
    print(f"Fallback  : {result.get('fallback_used_count', 'N/D')}")
    print(f"Objetivo  : {result.get('direct_target', 'N/D')}")
