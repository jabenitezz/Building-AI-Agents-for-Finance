"""Financial data helper for the OpenAI Self-Refine lab.

Fetches structured company metrics from Financial Datasets and converts them
into a compact, grounded text block for the LLM.
"""
...
def get_financial_data(ticker: str) -> str:
    """Fetch and format the financial data used by the Self-Refine loop."""
